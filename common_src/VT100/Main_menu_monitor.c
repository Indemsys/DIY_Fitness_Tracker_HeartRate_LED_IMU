...
static void     Do_return_defaul_module_settings(uint8_t keycode);
...
const T_VT100_Menu_item MENU_ENGINEERING_ITEMS[] =
{
  ...
  { '4', Do_return_defaul_module_settings, 0                    },
...
const T_VT100_Menu      MENU_ENGINEERING  =
{
  ...
  "\033[5C <4> - Returm default communication settings\r\n"
...
__weak  const T_VT100_Menu_item MENU_BASE_ITEMS[] =
{
  { 'R', 0                                 , 0 },
  { 'M', 0,                 (void *)&MENU_MAIN },
  { 0 }
...
__weak const T_VT100_Menu      MENU_APPLICATION       =
{
...
const T_VT100_Menu_item MENU_MAIN_ITEMS[] =
{
  ...
  { '2', Do_MOD_Params_editor           , (void *)&MENU_PARAMETERS    },
  { '3', 0                              , (void *)&MENU_MANAGEMENT    },
  { '4', 0                              , (void *)&MENU_APPLICATION   },
  { '5', Do_show_event_log              , 0                           },
  { '6', Do_Reset                       , 0                           },
  { '7', 0                              , (void *)&MENU_ENGINEERING   },
  { 'R', 0                              , 0                           },
  { 'M', 0                              , (void *)&MENU_MAIN          },
  { 0                                                 }
};
...
const T_VT100_Menu      MENU_MAIN             =
{
  ...
  "\033[5C <2> - Communication parameters\r\n"
  "\033[5C <3> - Management menu\r\n"
  "\033[5C <4> - Application diagnostic menu\r\n"
  "\033[5C <5> - Log viewer\r\n"
  "\033[5C <6> - Reset\r\n",
  MENU_MAIN_ITEMS,
};
...
static void Do_Copy_Module_Settings_to_File(uint8_t keycode)
{
  ...
  res = Save_settings_to(MODULE_PARAMS, MEDIA_TYPE_FILE, PARAMS_MODULE_JSON_FILE_NAME);
  if (res == RES_OK)
  {
...
static void     Do_erase_application_firmware(uint8_t keycode)
{
  ...
  do
  {
    ...
    if ((b == 'Y') || (b == 'y'))
    {
      ...
      res = Erase_firmware_area(APP_IMG_START_ADDRESS, APP_IMG_SIZE);
      VT100_set_cursor_pos(5, 0);
      MPRINTF(VT100_CLL_FM_CRSR);
