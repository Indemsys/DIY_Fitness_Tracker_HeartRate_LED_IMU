  ...
  // Тип микросхемы MAX17262REWL+T

  #define    CURRENT_MEASUREMENT_STEP      0.15625f       // mA, Signed two's-complement format
  #define    VOLTAGE_MEASUREMENT_STEP      (1.25f/16.0f)  // mV
  #define    TEMPER_MEASUREMENT_STEP       (1.0f/256.0f)  // C, Signed two's-complement format. 1°C LSb when reading only the upper byte.
  #define    CAPACITY_MEASUREMENT_STEP     0.5f           // mAh
  #define    PERCENTAGE_MEASUREMENT_STEP   (1.0f/256.0f)  // %,  1% LSb when reading only the upper byte
  #define    RESISTANCE_MEASUREMENT_STEP   (1.0f/4096.0f) // Ohm
  #define    TIME_MEASUREMENT_STEP         5.625f         // sec
