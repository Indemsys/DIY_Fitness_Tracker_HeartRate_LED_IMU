...
typedef struct
{
    ...
    uint32_t rx_func_period_us;
    uint32_t rx_func_max_period_us;
    uint32_t rx_func_duration_us;
    uint32_t rx_func_max_duration_us;
    uint32_t rx_pack_count;

    T_sys_timestump     tstart;
    T_sys_timestump     tfinish;
    T_sys_timestump     tfinish_prev;
