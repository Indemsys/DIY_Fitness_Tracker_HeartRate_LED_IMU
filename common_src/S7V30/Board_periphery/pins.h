...
void      S7G2_WIFI_pins_shutdown(void);
void      S7G2_SDCard_pins_shutdown(void);
void      S7G2_SSI_pins_shutdown(void);
void      S7G2_SDRAM_pins_shutdown(void);
#endif
