...
extern void      Set_AUD_SHDN   (int32_t v);
...
transfer_info_t DAC0_dtc[] =
{
  ...
  {ADDR_FIXED,        DST_REPEATED,    DISEL_0_IR_RES,    CHAIN_AFTER_LOOP,   ADDR__INCR,      UNIT_2_BYTE,      MODE_NORMAL   ,&audio_buf[0]    ,(void *)&R_DAC->DADRn[0]           ,0        ,AUDIO_BUF_SAMPLES_NUM },
...
extern const transfer_instance_t   DTC_DAC0_AGT_inst;
dtc_instance_ctrl_t                DTC_DAC0_ctrl;

transfer_cfg_t DTC_DAC0_AGT_cfg =
{
  .p_info              = DAC0_dtc,
  ...
  .p_context           =&DTC_DAC0_AGT_inst,
  .irq_ipl             =(BSP_IRQ_DISABLED)
};

/* Instance structure to use this module. */
const transfer_instance_t DTC_DAC0_AGT_inst =
{
  .p_ctrl             =&DTC_DAC0_ctrl,
  .p_cfg              =&DTC_DAC0_AGT_cfg,
...
void Sound_DAC_init_player_periphery(uint32_t sample_rate)
{
  ...
  R_ELC->ELSEGRnRC0[0].ELSEGRn_b.WI = 0; // Сбросов в 0 разрешаем запись в регистр
  ...
  DTC_DAC0_AGT_inst.p_api->open(DTC_DAC0_AGT_inst.p_ctrl,DTC_DAC0_AGT_inst.p_cfg);
  DTC_DAC0_AGT_inst.p_api->enable(DTC_DAC0_AGT_inst.p_ctrl);
