...
#define APP_IMG_SIZE              0x00280000                     // Размер образа основной программы во Flash памяти микроконтроллера
#define APP_IMG_START_ADDRESS     0x00080000                     // Адрес хранения образа основной программы во Flash памяти микроконтроллера
