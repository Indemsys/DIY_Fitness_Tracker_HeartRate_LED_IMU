...
/*                                                                        */
/**************************************************************************/
UINT  _nxde_sntp_client_initialize_unicast(NX_SNTP_CLIENT *client_ptr, NXD_ADDRESS *unicast_time_server, ULONG poll_interval)
{
...
UINT  status;
    ...
    status = _nxd_sntp_client_initialize_unicast(client_ptr, unicast_time_server, poll_interval);
...
/*                                                                        */
/**************************************************************************/
UINT  _nxd_sntp_client_initialize_unicast(NX_SNTP_CLIENT *client_ptr, NXD_ADDRESS *unicast_time_server, ULONG poll_inteval)
{

    client_ptr -> nx_sntp_client_unicast_poll_interval_const = poll_inteval;
    /* Set the Client polling interval.  */
    client_ptr -> nx_sntp_client_unicast_poll_interval = (client_ptr -> nx_sntp_client_unicast_poll_interval_const  * NX_IP_PERIODIC_RATE);
...
/*                                                                        */
/**************************************************************************/
UINT  _nxe_sntp_client_initialize_unicast(NX_SNTP_CLIENT *client_ptr, ULONG unicast_time_server, ULONG poll_interval)
{
...
UINT status;
    ...
    /* Call the actual Client for initialize unicast service.  */
    status = _nx_sntp_client_initialize_unicast(client_ptr, unicast_time_server, poll_interval);
...
/*                                                                        */
/**************************************************************************/
UINT  _nx_sntp_client_initialize_unicast(NX_SNTP_CLIENT *client_ptr, ULONG unicast_time_server, ULONG poll_interval)
{
...
NXD_ADDRESS duo_unicast_time_server;
    ...
    status = _nxd_sntp_client_initialize_unicast(client_ptr, &duo_unicast_time_server, poll_interval);
...
ULONG   sntp_events;
    ...
    if (client_ptr -> nx_sntp_client_unicast_poll_interval == 0)
    {
        ...
        if ((NX_SNTP_CLIENT_MAX_TIME_LAPSE * NX_IP_PERIODIC_RATE - client_ptr -> nx_sntp_update_time_remaining) >
            (client_ptr -> nx_sntp_client_unicast_poll_interval_const  * NX_IP_PERIODIC_RATE))
        {
            ...
            client_ptr -> nx_sntp_client_unicast_poll_interval =
                NX_IP_PERIODIC_RATE * client_ptr -> nx_sntp_client_unicast_poll_interval_const * NX_SNTP_CLIENT_EXP_BACKOFF_RATE * client_ptr -> nx_sntp_client_backoff_count;
        }
        else
        {
