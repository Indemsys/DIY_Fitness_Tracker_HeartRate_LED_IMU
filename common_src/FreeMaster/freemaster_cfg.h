...
// Built-in recorder
  #ifdef ENABLE_SDRAM
    #define FMSTR_REC_BUFF_SIZE      (1024*128) // Built-in buffer size of recorder #0. Set to 0 to use runtime settings.
  #else
    #define FMSTR_REC_BUFF_SIZE      (1024*4)   // Built-in buffer size of recorder #0. Set to 0 to use runtime settings.
  #endif
