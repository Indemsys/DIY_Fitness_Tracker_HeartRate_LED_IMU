...
GX_DISPLAY display_120_28_control_block;
GX_WINDOW_ROOT display_120_28_root_window;
GX_CANVAS  display_120_28_canvas_control_block;
extern GX_CONST GX_THEME *display_120_28_theme_table[];
extern GX_CONST GX_STRING *display_120_28_language_table[];

GX_STUDIO_DISPLAY_INFO MKR_RGB_Shield_display_table[1] =
{
    {
    "display_120_28",
    "display_120_28_canvas",
    display_120_28_theme_table,
    display_120_28_language_table,
    DISPLAY_120_28_THEME_TABLE_SIZE,
    DISPLAY_120_28_LANGUAGE_TABLE_SIZE,
    DISPLAY_120_28_STRING_TABLE_SIZE,
    120,                                     /* x resolution                   */
    28,                                      /* y resolution                   */
    &display_120_28_control_block,
    &display_120_28_canvas_control_block,
    &display_120_28_root_window,
    GX_NULL,                                 /* canvas memory area             */
    6720,                                    /* canvas memory size in bytes    */
...
GX_CONST GX_STUDIO_WIDGET window_main_txt_define =
{
    ...
    {0, -1, 118, 6},                         /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_MAIN_CONTROL_BLOCK, window_main_txt), /* control block     */
    (void *) &window_main_txt_properties     /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_main_define =
{
    ...
    (VOID (*)(GX_WIDGET *)) Main_window_draw_callback, /* drawing function override */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) Main_window_event_callback, /* event function override */
    {0, 0, 118, 26},                         /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &window_main_txt_define,                 /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_main_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY MKR_RGB_Shield_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = MKR_RGB_Shield_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &MKR_RGB_Shield_display_table[display];
